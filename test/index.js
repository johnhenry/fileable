...
tape('cli test: fileable build', async ({ ok, end }) => {
    ...
    // execSync(`npm run fileable -- build https://raw.githubusercontent.com/johnhenry/fileable/master/test/example/template.jsx ${destination} --no-test --input ./test/example/input.js `);
